...
type OrderServiceClient interface {
	GetOrderList(ctx context.Context, in *GetOrderListRequest, opts ...grpc.CallOption) (*CommonResponse, error)
}
...
func (c *orderServiceClient) GetOrderList(ctx context.Context, in *GetOrderListRequest, opts ...grpc.CallOption) (*CommonResponse, error) {
...
type OrderServiceServer interface {
	GetOrderList(context.Context, *GetOrderListRequest) (*CommonResponse, error)
...
func (UnimplementedOrderServiceServer) GetOrderList(context.Context, *GetOrderListRequest) (*CommonResponse, error) {
