...
func (c *userServiceClient) GetUserByName(ctx context.Context, in *UserReq, opts ...grpc.CallOption) (*UserResp, error) {
...
type UserServiceServer interface {
	GetUserByName(context.Context, *UserReq) (*UserResp, error)
...
func (UnimplementedUserServiceServer) GetUserByName(context.Context, *UserReq) (*UserResp, error) {
...
func _UserService_GetUserByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserByName(ctx, req.(*UserReq))
	}
