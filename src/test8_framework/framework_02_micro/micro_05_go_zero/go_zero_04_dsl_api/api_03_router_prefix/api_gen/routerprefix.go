...
import (
	...
	"go-dev/src/test8_framework/framework_02_micro/micro_05_go_zero/go_zero_04_dsl_api/api_03_router_prefix/api_gen/internal/handler"
...
var configFile = flag.String("f", "etc/routerprefix.yaml", "the config file")
