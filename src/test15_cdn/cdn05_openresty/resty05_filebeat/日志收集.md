...
```shell
root@chenjiayaosdev:/home/lxc/cdn/filebeat# pwd
/home/lxc/cdn/filebeat
```

```shell
mkdir -p /home/lxc/cdn/filebeat/logs && mkdir -p /home/lxc/cdn/filebeat/kafka-data && mkdir -p /home/lxc/cdn/filebeat/filebeat-data
chmod -R 777 /home/lxc/cdn/filebeat
cd /home/lxc/cdn/filebeat
```
chmod -R 777 /home/lxc/cdn/filebeat/kafka-init.sh

`vim filebeat.yml`
chmod go-w ./filebeat.yml

`kafka_server_jaas.conf`
username/password → broker 自身内部通信
user_xxx="xxx" → 客户端账号密码（你 Filebeat 用的）


`vim docker-compose.yaml`


sudo chmod -R 777 /home/lxc/cdn/filebeat
scp ./docker-compose.yaml lxc@192.168.203.182:/home/lxc/cdn/filebeat
scp ./filebeat.yml lxc@192.168.203.182:/home/lxc/cdn/filebeat
scp ./kafka_server_jaas.conf lxc@192.168.203.182:/home/lxc/cdn/filebeat
...
192.168.203.182
python3 /home/lxc/cdn/cdn-gateway/scripts/generate_logs.py --count 10
