...
// 在[enhance01.go](enhance01%2Fenhance01.go)的基础上支持可以处理更多 Qtype（AAAA / CNAME / MX 等记录）
...
func main() {
	...
	// 2、自定义dns处理器
	dnsServer.Handler = &enhance02DNSHandler{}
...
type enhance02DNSHandler struct{}

func (h enhance02DNSHandler) ServeDNS(w dns.ResponseWriter, r *dns.Msg) {
	// 1、创建msg消息
	msg := &dns.Msg{}
	msg.SetReply(r)
	...
	customMsg := h.upstreamDNSQuery(qname, qtype)
	if customMsg != nil {
		customMsg.Id = msg.Id
		w.WriteMsg(customMsg)
		return
	}
...
func (h enhance02DNSHandler) customDNSQuery(msg *dns.Msg, qname string, qtype uint16, rrRecords []dns.RR) {
...
func (h enhance02DNSHandler) upstreamDNSQuery(qname string, qtype uint16) *dns.Msg {
	upStreamMsg := &dns.Msg{}
...
// dig @127.0.0.1 local.com AAAA
// dig @127.0.0.1 local.com CNAME
...
;; WHEN: Mon Nov 24 14:08:20 CST 2025
;; MSG SIZE  rcvd: 52

lxc20250729@lxc20250729deMacBook-Pro ~ % dig @127.0.0.1 local.com AAAA

; <<>> DiG 9.10.6 <<>> @127.0.0.1 local.com AAAA
; (1 server found)
;; global options: +cmd
;; Got answer:
...
;; Query time: 0 msec
;; SERVER: 127.0.0.1#53(127.0.0.1)
;; WHEN: Mon Nov 24 14:08:30 CST 2025
;; MSG SIZE  rcvd: 64

lxc20250729@lxc20250729deMacBook-Pro ~ % dig @127.0.0.1 local.com CNAME

; <<>> DiG 9.10.6 <<>> @127.0.0.1 local.com CNAME
; (1 server found)
;; global options: +cmd
;; Got answer:
...
;; ANSWER SECTION:
www.local.com.		300	IN	CNAME	local.com.

;; Query time: 0 msec
;; SERVER: 127.0.0.1#53(127.0.0.1)
;; WHEN: Mon Nov 24 14:08:42 CST 2025
;; MSG SIZE  rcvd: 63
...
;; ANSWER SECTION:
google.com.		59	IN	A	142.250.71.142

;; Query time: 26 msec
;; SERVER: 127.0.0.1#53(127.0.0.1)
;; WHEN: Mon Nov 24 14:08:26 CST 2025
;; MSG SIZE  rcvd: 54
