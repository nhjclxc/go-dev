...
func main() {
	...
	// http://127.0.0.1:8080/api/sendTask?id=1&name=task1&bizType=test1&delayTmp=3
	// http://127.0.0.1:8080/api/sendTask?id=1&name=task1&bizType=test1&delayTmp=10
	// http://127.0.0.1:8080/api/sendTask?id=3&name=task3&bizType=test3&delayTmp=5
